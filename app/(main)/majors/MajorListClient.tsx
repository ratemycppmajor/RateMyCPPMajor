...
export default function MajorListClient({ colleges }: Props) {
  ...
  const searchFilteredColleges = filteredColleges
    .map((college) => {
      ...
      const filteredDepartments = college.departments
        .map((dept) => {
          ...
          const filteredMajors = dept.majors
                ...
                {colleges.map((college) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="text-sm font-medium leading-none text-card-primary ">
                        {college.name}
                      </div>
                    </div>
                  </label>
