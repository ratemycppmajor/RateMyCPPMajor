...
const Hero = () => {
  ...
  return (
    <div
      ...
      style={{
        background:
          'linear-gradient(0deg,rgba(255, 255, 255, 1) 40%, rgba(255, 184, 28, 1) 60%, rgba(164, 214, 94, 1) 100%)',
      }}
    >
      <HomeNavbar />
      ...
      <div className="mx-auto max-w-7xl flex-col px-6 py-20 flex lg:items-center gap-16 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:shrink-0">
          ...
          <span className="text-4xl font-bold sm:text-6xl text-center block">
            CPP Major Insights
          </span>
